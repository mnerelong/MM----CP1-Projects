...
while True:
    try:
        quantity = int(input("How many would you like? ")) # while true loop my beloved!
    except:
        print("Arrr?? That's not a number???")
    else:
        break

total = price * quantity # quantity was a string. Switched it to be an integer. run time error.
